function RFgen = create_avRFchain_3dim_pass(n,a,lambda,bincoeffmat)
...
% 
% Note: the only difference from the main function I use (i.e.
% "create_avRFchain_3dim"), is that I pass the matrix of binomial
