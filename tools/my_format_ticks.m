...
%
%Usage: [hx,hy] = ...
%          format_tick(h,tickx,ticky,tickposx,tickposy,rotx,roty,offsetx,offsety,...
%                      varargin);
%
...
%                  (Can use [] or not specify to ignore) Default = 0.0
%       offsetx  : Label offset from x axis in fraction of total range
%                  (Can use [] or not specify to ignore) Default = 0.0
%       offsety  : Label offset from y axis in fraction of total range
%                  (Can use [] or not specify to ignore) Default = 0.0
%
%Optional Inputs:%                
...
%     hy = -1;
    ...
    set(h,'YTick',tickposy);
%    set(h,'XTick',tickposx);
    %check the lengths of the ytick positions and ytick labels
    l1 = length(ticky);
    l2 = length(tickposy);
    if l1==0;
